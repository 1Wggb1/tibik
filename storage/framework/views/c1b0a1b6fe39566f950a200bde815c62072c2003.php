...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <title><?php echo e(__('Tibiko\'s - Sistema de Gerenciamento de Loja')); ?></title>
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('material')); ?>/img/logo.png">
    <link rel="icon" type="image/png" href="<?php echo e(asset('material')); ?>/img/logo.png">
...
</html><?php /**PATH C:\projetos\tibikos\resources\views/layouts/app.blade.php ENDPATH**/ ?>